...
<script runat="server">
	...
	public override void SetConfig()
	{
		...
		type = ResourceType.Add( "quangcao" );
		type.Url = BaseUrl + "quangcao/";
		type.Dir = BaseDir == "" ? "" : BaseDir + "quangcao/";
		type.MaxSize = 0;
		...
		type = ResourceType.Add( "anhbia" );
		type.Url = BaseUrl + "anhbia/";
		type.Dir = BaseDir == "" ? "" : BaseDir + "anhbia/";
		type.MaxSize = 0;
